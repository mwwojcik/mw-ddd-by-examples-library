...
public class BookFixture {
    ...
    public static Set<Hold> booksOnHold(int numberOfHolds) {
        return IntStream
    ...
    public static Map<LibraryBranchId, Set<BookId>> overdueCheckoutsAtBranch(int numberOfCheckouts, LibraryBranchId branchId) {
    ...
    public static CheckedOutBook bookCheckedOut() {
        return new CheckedOutBook(anyBookInformation(),anyBranchId(),anyPatronId());
    }
}
